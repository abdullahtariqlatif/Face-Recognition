...
prediction_RF_label = le.inverse_transform(prediction_RF)
...
print("Accuracy = ", (metrics.accuracy_score(test_labels, prediction_RF_label)) * 100, "%")
...
prediction_RF_test = RF_model.predict(input_img_features)[0]
prediction_RF_test_label = le.inverse_transform([prediction_RF_test])  # Reverse the label encoder to original name

print("The prediction for this image is: ", prediction_RF_test_label)
print("The actual label for this image is: ", test_labels[n])

try :
    print("Printing Accuracy")
    # Print overall accuracy
    print("Accuracy Random = ", (metrics.accuracy_score(test_labels, prediction_RF_test_label)) * 100, "%")
except:
    print("Acurracy could not be printed")
